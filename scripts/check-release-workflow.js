...
const requiredWorkflowText = [
  ...
  "protected v* tags and release branch rules are active",
  "CodeQL alerts are triaged, Gitleaks and GitHub secret-scanning alerts are triaged",
  "the publisher is authorized",
  "this workflow does not verify live GitHub settings or alert state",
